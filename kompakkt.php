...
function kompakkt_menu() {
	...
	add_menu_page( "Kompakkt", "Kompakkt", "manage_options", "kompakkt", "kompakkt_main_page", $menu_svg_encoded );
	add_submenu_page( "kompakkt", "Manage models", "Manage", "manage_options", "manage-models", "kompakkt_manage_models" );
	add_submenu_page( "kompakkt", "Upload a model", "Upload", "manage_options", "upload-model", "kompakkt_upload_model" );
}
